...
func (s *CalendarSuite) TestAttachTo() {
	...
	s.Run("calendar can be retrieved from old and new table", func() {
		...
		s.Require().Contains(body, "2024-06-21 12:30:00 +0000 UTC: 108 saludos al sol")
		s.Require().Contains(body, "2024-06-26 22:30:00 +0000 UTC: ver pelis")
	})
	...
	s.Run("new events can be created", func() {
		...
		s.Require().Contains(body, "8 de marzo: comer rico")
		s.Require().Contains(body, "25 de mayo: tomar mate")
		s.Require().Contains(body, "2024-06-21 12:30: 108 saludos al sol")
		s.Require().Contains(body, "2024-06-26 22:30: ver pelis")
		s.Require().Contains(body, "2024-07-23 22:15: pasarla lindo")
...
func (s *CalendarSuite) SetupSuite() {
	...
	calendar.AttachTo(r, "", s.dbPool, s.authenticator)
